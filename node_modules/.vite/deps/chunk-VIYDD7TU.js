import {
  DEV
} from "./chunk-6VNROFAT.js";
import {
  EMPTY_FUNC,
  run_all,
  subscribe_to_store
} from "./chunk-QDCFBVTW.js";
...
var readonly_error = (_, prop2) => {
  throw new Error(
    `Non-bound props cannot be mutated — to make the \`${prop2}\` settable, ensure the object it is used within is bound as a prop \`bind:<prop>={...}\`. Fallback values can never be mutated.`
  );
};
var handler = {
...
function derived_safe_equal(init2) {
  const signal = derived(init2);
  signal.e = safe_equal;
  return signal;
}
...
//# sourceMappingURL=chunk-VIYDD7TU.js.map
